        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 16, padding: '20px 24px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              <div style={{ width: 8, height: 8, borderRadius: '50%', background: loading ? '#06B6D4' : result ? '#10B981' : '#D1D5DB' }} />
              <span style={{ fontSize: 12, fontWeight: 700, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.07em' }}>Execution Status</span>
            </div>
            {loading
              ? <p style={{ fontSize: 13, color: '#06B6D4', margin: 0 }}>Agent running — analyzing data…</p>
              : result
                ...
                : <p style={{ fontSize: 13, color: '#D1D5DB', margin: 0 }}>Ask a question to analyze your campaign data.</p>
            }
